...
import com.android.intelligent.interfaces.SelectDemonstrateInterface;
import com.android.intelligent.presenter.SelectDemonstratePresenter;
...
public class SelectDemonstrateActivity extends BaseActivity implements SelectDemonstrateInterface {
    ...
    private boolean isSelect = false;  //判断是否已经选择演示场景
            ...
            return_Btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (isSelect){
                        ...
                        Toast.makeText(SelectDemonstrateActivity.this, "请选择一台演示场景", Toast.LENGTH_SHORT).show();
                    }
